 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const he=()=>ce().__FIREBASE_DEFAULTS__,le=()=>{if(typeof process>"u"||typeof x>"u")return;const t=x.__FIREBASE_DEFAULTS__;if(t)return JSON.parse(t)},de=()=>{if(typeof document>"u")return;let t;try{t=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=t&&ae(t[1]);return e&&JSON.parse(e)},P=()=>{try{return he()||le()||de()}catch(t){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${t}`);return}},Ot=t=>{var e,n;return(n=(e=P())===null||e===void 0?void 0:e.emulatorHosts)===null||n===void 0?void 0:n[t]},q=()=>{var t;return(t=P())===null||t===void 0?void 0:t.config},Tt=t=>{var e;return(e=P())===null||e===void 0?void 0:e[`_${t}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fe{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(je(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function je(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const M="@firebase/app",V="0.9.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const p=new Be("@firebase/app"),Ue="@firebase/app-compat",Ve="@firebase/analytics-compat",ze="@firebase/analytics",We="@firebase/app-check-compat",Ge="@firebase/app-check",Ke="@firebase/auth",Je="@firebase/auth-compat",Ye="@firebase/database",qe="@firebase/database-compat",Xe="@firebase/functions",Qe="@firebase/functions-compat",Ze="@firebase/installations",et="@firebase/installations-compat",tt="@firebase/messaging",nt="@firebase/messaging-compat",rt="@firebase/performance",st="@firebase/performance-compat",ot="@firebase/remote-config",it="@firebase/remote-config-compat",at="@firebase/storage",ct="@firebase/storage-compat",ht="@firebase/firestore",lt="@firebase/firestore-compat",dt="firebase",ft="9.23.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const N="[DEFAULT]",ut={[M]:"fire-core",[Ue]:"fire-core-compat",[ze]:"fire-analytics",[Ve]:"fire-analytics-compat",[Ge]:"fire-app-check",[We]:"fire-app-check-compat",[Ke]:"fire-auth",[Je]:"fire-auth-compat",[Ye]:"fire-rtdb",[qe]:"fire-rtdb-compat",[Xe]:"fire-fn",[Qe]:"fire-fn-compat",[Ze]:"fire-iid",[et]:"fire-iid-compat",[tt]:"fire-fcm",[nt]:"fire-fcm-compat",[rt]:"fire-perf",[st]:"fire-perf-compat",[ot]:"fire-rc",[it]:"fire-rc-compat",[at]:"fire-gcs",[ct]:"fire-gcs-compat",[ht]:"fire-fst",[lt]:"fire-fst-compat","fire-js":"fire-js",[dt]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vt=ft;function gt(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:N,automaticDataCollectionEnabled:!1},e),r=s.name;if(typeof r!="string"||!r)throw f.create("bad-app-name",{appName:String(r)});if(n||(n=q()),!n)throw f.create("no-options");const o=I.get(r);if(o){if(B(n,o.options)&&B(s,o.config))return o;throw f.create("duplicate-app",{appName:r})}const i=new De(r);for(const h of R.values())i.addComponent(h);const a=new bt(n,s,i);return I.set(r,a),a}function zt(t=N){const e=I.get(t);if(!e&&t===N&&q())return gt();if(!e)throw f.create("no-app",{appName:t});return e}function _(t,e,n){var s;let r=(s=ut[t])!==null&&s!==void 0?s:t;n&&(r+=`-${n}`);const o=r.match(/\s|\//),i=e.match(/\s|\//);if(o||i){const a=[`Unable to register library "${r}" with version "${e}":`];o&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),o&&i&&a.push("and"),i&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),p.warn(a.join(" "));return}$(new v(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Et="firebase-heartbeat-database",yt=1,b="firebase-heartbeat-store";let A=null;function te(){return A||(A=He(Et,yt,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(b)}}}).catch(t=>{throw f.create("idb-open",{originalErrorMessage:t.message})})),A}async function _t(t){try{return await(await te()).transaction(b).objectStore(b).get(ne(t))}catch(e){if(e instanceof g)p.warn(e.message);else{const n=f.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});p.warn(n.message)}}}async function z(t,e){try{const s=(await te()).transaction(b,"readwrite");await s.objectStore(b).put(e,ne(t)),await s.done}catch(n){if(n instanceof g)p.warn(n.message);else{const s=f.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});p.warn(s.message)}}}function ne(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ct(t){$(new v("platform-logger",e=>new Fe(e),"PRIVATE")),$(new v("heartbeat",e=>new Dt(e),"PRIVATE")),_(M,V,t),_(M,V,"esm2017"),_("fire-js","")}Ct("");var At="firebase",Bt="9.23.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */_(At,Bt,"app");export{v as C,Q as E,g as F,Be as L,Vt as S,$ as _,Rt as a,Nt as b,jt as c,Ft as d,c as e,X as f,Tt as g,ae as h,Mt as i,Ut as j,Ot as k,zt as l,B as m,$t as n,Lt as o,xt as p,Ht as q,_ as r,kt as s,ue as t,Pt as u,pe as v,gt as w};
